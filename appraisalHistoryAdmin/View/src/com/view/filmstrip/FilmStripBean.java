...
//        if (ItemNodeId.equalsIgnoreCase("Self")) {
//                   ADFContext.getCurrent().getSessionScope().put("reqPurpose", "self");
//                   }
//        else if(ItemNodeId.equalsIgnoreCase("Self")){
//                ADFContext.getCurrent().getSessionScope().put("reqPurpose", "others");
//            }
    }
    ...
    public TaskFlowId getDynamicTaskFlowId() {
        ...
        if (ADFContext.getCurrent()
            ...
            groupId = (String) ADFContext.getCurrent()
                                         .getSessionScope()
                                         .get("selectedGroupId");
        if (ADFContext.getCurrent()
                      .getSessionScope()
                      .get("selectedItemId") != null)
            itemId = (String) ADFContext.getCurrent()
                                        .getSessionScope()
                                        .get("selectedItemId");
